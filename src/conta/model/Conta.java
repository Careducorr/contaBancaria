...
public abstract class Conta {
	...
	public boolean transferir(float valor, Conta destino) {
		if (this.sacar(valor)) { // Tenta sacar o valor da conta de origem
	        ...
	        System.out.println("\nTransferência de R$" + valor + " realizada com sucesso para a conta de " + destino.getTitular());
	        return true;
	    } else {
	        System.out.println("\nTransferência não realizada devido a saldo insuficiente na conta de origem.");
	        return false;
	    }
	}
